...
[![Tests](https://img.shields.io/badge/tests-400%20unit%20passed-brightgreen)]()
...
| **单元测试** | **400 passed, 2 skipped**（覆盖 agent loop、L1/L2/L3 权限分级、17 个 MCP server、KB、user_kb、method_selection、notify、web/tui 前端）| `python -m pytest tests/unit/` |
